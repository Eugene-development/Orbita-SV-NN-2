const content_Swiper_v2 = [
    {
        title_Marketing_v2: 'Цена - 1290 рублей',
        description_Marketing_v2:
            'Утеплитель техноблок стандарт (1200*600*100мм), 0,288 м3. ТЕХНОБЛОК – это негорючие, гидрофобизированные тепло-, звукоизоляционные плиты из минеральной ваты на основе горных пород базальтовой группы. Наличие на складе уточняйте у наших менеджеров.',
        img_Marketing_v2:
    ...
    {
        title_Marketing_v2: 'Цена - 530 рублей',
        description_Marketing_v2:
