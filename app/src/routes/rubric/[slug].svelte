<script context="module">
  ...
  export const load = async ({ fetch, params, url }) => {
    ...
    const title =
      nameHead +
      " в Нижнем Новгороде || База стройматериалов Орбита-Строй в Нижнем Новгороде";
    const description =
      nameHead +
      " по низким ценам в Нижнем Новгороде и области. Предлагаем доставку и скидки для товара " +
      nameHead +
      ".";
            ...
            {#each rubric as { id, slug, name }}
              ...
              >
                <div class="px-6 py-8 text-center sm:p-10 sm:pb-6">
                  <div>
                    <h3
                      class="inline-flex px-8 py-1 rounded-full text-sm  font-semibold tracking-wide uppercase bg-red-50 text-red-900"
                      id="tier-standard"
                    >
                      {nameHead}
                    </h3>
                  ...
                  <div
                    class="mt-4  text-center items-baseline text-2xl font-extrabold"
                  >
                    {name}
                  </div>
                ...
                <div
                  class="flex-1 flex flex-col justify-between px-6  sm:p-10 sm:pt-6"
                >
                  <ul class="space-y-2" />
        ...
        <div class="max-w-md mx-auto lg:max-w-7xl">
          ...
          >
            ...
            <div class="flex-1">
              <div>
                <h2
                  class="inline-flex px-4 py-1 rounded-full text-2xl font-semibold tracking-wide bg-white text-slate-800"
                >
                  {text.titleText}
                </h2>
              </div>
          ...
          <div class="mt-6 rounded-md shadow lg:flex-shrink-0">
            <a
              ...
              class="flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-slate-900 bg-slate-50 hover:bg-slate-100"
            >
              {nameHead} со скидкой
            </a>
          </div>
