        ...
        <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
                    ...
                    <dl class="mt-8 space-y-6">
                        ...
                        <dd class="flex text-base text-indigo-50">
                            ...
                            <span class="ml-3">8 (800) 555-8-111 (звонок бесплатный)</span>
                        </dd>
                        <dd class="flex text-base text-indigo-50">
                            <!-- Heroicon name: outline/phone -->
                            <svg class="flex-shrink-0 w-6 h-6 text-indigo-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                            ...
                            <span class="ml-3">8 (930) 688-88-62 </span>
                        </dd>
                        ...
                        <dt><span class="sr-only">Почта</span></dt>
                        <dd class="flex text-base text-indigo-50">
                            <a class="text-base text-indigo-50 flex" href="https://vk.com/orbita_stroy"
                               target="_blank">
                                <svg class="mr-3 lex-shrink-0 w-6 h-6 text-indigo-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                    <h3 class="text-lg font-medium text-gray-900 border-b pb-2">Отправить запрос или коммерческое предложение:</h3>
                    <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                            ...
                            <div class=" mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-red-800 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                        ...
                        <div class="sm:col-span-2 sm:flex sm:justify-end">
                            <button type="submit" class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-800 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:w-auto">
                                Отправить
                            </button>
                        </div>
                    </form>
