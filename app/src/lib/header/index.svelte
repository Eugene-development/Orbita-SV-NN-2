                ...
                <div class="flex items-center px-2 lg:px-0">
                    <div class="hidden lg:block ">
                        <div class="flex space-x-4">
                            ...
                            <p class="text-gray-300 px-3 rounded-md text-base font-medium">8 (800) 555-8-111</p>
                            <p class="text-gray-300 px-3 rounded-md text-base font-medium">8 (930) 688-88-62</p>
                            <p class="text-gray-300 px-3 rounded-md text-base font-medium">8 (902) 303-36-54</p>
                        </div>
                    </div>
                </div>
                <div class="flex-1 flex justify-center px-2 lg:ml-6 lg:justify-end">
                    <div class="max-w-lg w-full lg:max-w-xs">
                        ...
                        <div class="relative">
                            ...
                            <input id="search" name="search" class="block w-full pl-10  py-1 border border-transparent rounded-md leading-5 bg-slate-100 text-gray-300 placeholder-gray-400 focus:outline-none focus:bg-white focus:border-white focus:ring-white focus:text-gray-900 sm:text-sm" placeholder="Поиск товара" type="search">
                        </div>
                    </div>
                </div>
...
<!--&lt;!&ndash;                                &lt;!&ndash; Active: "bg-gray-100", Not Active: "" &ndash;&gt;&ndash;&gt;-->
