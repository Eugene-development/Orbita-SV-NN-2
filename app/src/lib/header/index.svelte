...
<!--                            </div>-->
        ...
        <div class="lg:hidden" id="mobile-menu">
            ...
            <div class="px-2 sm:px-4 md:px-8 pt-2 pb-3 space-y-1 ">
                <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                <div class="mx-auto flex justify-between items-center">
                    ...
                    <div class="flex">
                        ...
                        <p class="text-gray-300 pl-1 rounded-md text-xs sm:text-base md:text-lg font-medium">8 800-555-8-111</p>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <p class="text-gray-300 pl-1 rounded-md text-xs sm:text-base md:text-lg font-medium">8 930-688-88-62</p>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <p class="text-gray-300 pl-1 rounded-md text-xs sm:text-base md:text-lg font-medium">8 902-303-36-54</p>
                    </div>
                </div>
