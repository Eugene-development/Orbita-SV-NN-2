        ...
        <div class="max-w-7xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
            <div class="pr-16 sm:text-center sm:px-16">
                <p class="font-medium text-white antialiased">
                    <span class="md:hidden">Специальные цены на утеплитель.</span>
                    <span class="hidden md:inline"> Спецпредложение. Только в эти выходные! Специальные цены на утеплитель.</span>
...
<!--                            <p class="text-gray-300 pr-3 rounded-md text-base font-medium">8 (800) 555-8-111</p>-->
                            ...
                            <a href="tel:+79023033654" class="text-gray-300 pr-2 rounded-md text-base font-medium">8 (902) 303-36-54</a>
                            ...
                            <a href="tel:+79306888862" class="text-gray-300 pr-2 rounded-md text-base font-medium">8 (930) 688-88-62</a>

                            <svg class="h-6 w-6 text-red-400"
                                 xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                            </svg>
                            <span class="text-gray-300 pr-2 rounded-md text-base font-medium">info@orbita-stroy.com</span>
                ...
                <div class="hidden lg:block lg:ml-4">
                    <div class="flex items-center">
                        ...
                        <button class="flex-shrink-0 bg-red-400 p-1 rounded-full text-gray-50 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                                type="button">
        ...
        <div class="lg:hidden" id="mobile-menu">
            <div class="pt-4 pb-3 border-t border-gray-700">
                <div class="flex items-center px-5">
                    ...
                    <!--                    </div>-->
                    <button class="flex-shrink-0 bg-red-400 p-1 rounded-full text-slate-50 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white"
                            type="button">
                        <span class="sr-only">View notifications</span>
                        <!-- Heroicon name: outline/bell -->
                        <svg aria-hidden="true" class="h-6 w-6" fill="none" stroke="currentColor"
...
<!--                    </div>-->
                    ...
                    <div class="flex">
                        <svg class="h-5 sm:h-5 md:h-6 w-4 sm:w-5 md:w-6 text-red-400"
                        ...
                        <a class="text-gray-200 pl-1 rounded-md text-sm sm:text-base md:text-lg font-medium"
            ...
            <div class="max-w-full mx-auto flex justify-between items-center px-2 py-4 sm:px-6 sm:py-3 lg:px-10 md:space-x-8">
                ...
                <div class="hidden lg:flex-1 lg:flex sm:items-center sm:justify-between">
                    ...
                    <div class="flex items-center md:ml-12">
                        <a class="ml-8 inline-flex items-center justify-center px-4 py-1 border border-transparent rounded-md text-base font-medium text-white bg-gray-800 hover:bg-gray-800 shadow-lg shadow-gray-700/50"
                           href="/shop/cart"
                           sveltekit:noscroll>
